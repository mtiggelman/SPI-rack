...
class M2j_module(object):
    ...
    def __init__(self, spi_rack, module):
        ...
        self.spi_rack.write_data(self.module, 0, MAX5702_MODE, s_data)
    ...
    def clear_rf_clip(self):
        ...
        # Resets clipped bit
        self.spi_rack.write_data(self.module, 5, 0, bytearray([0xF7]))
        self.spi_rack.write_data(self.module, 5, 0, bytearray([0xFF]))
